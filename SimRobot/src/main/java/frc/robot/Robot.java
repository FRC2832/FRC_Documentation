...
public class Robot extends TimedRobot {
    ...
    public void robotInit() {
        ...
        driveStick = new DriveStick(driverCont, drive);
        driveButton = new DriveButton(driverCont, drive);
        autoSturn = new AutoSTurn(drive);
    }
    ...
    public void teleopPeriodic() {
        // only one of these should be active at a time,
        // although both could be on and the last one would take priority
        driveStick.Periodic();
        // driveButton.Periodic();
    }
